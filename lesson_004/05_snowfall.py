...
# TODO Постарался сделать более читаемым код.
# TODO Можно, пожалуйста, подробнее, что конкретно не читаемо было для Вас.
# TODO Как бы Вы это написали, а лучше на примере из 05_snowfall.py
